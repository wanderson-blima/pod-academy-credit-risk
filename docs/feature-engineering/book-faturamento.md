...
> **Prefixo**: `FAT_` (no book consolidado) | **Total**: 114 variaveis
...
graph TD
    ...
    subgraph "Silver.book"
        OUTPUT["faturamento<br/>114 variaveis<br/>Particionado por SAFRA"]
    end
