...
Analise do perfil de clientes Claro que migram de planos Pre-pago para Controle, focando na previsao de First Payment Default (FPD). O estudo abrange 3.9 milhoes de registros com 468 features comportamentais, demograficas e transacionais, cobrindo 6 SAFRAs (outubro/2024 a marco/2025).
...
- **Features**: 468 (cadastro + REC_ + PAG_ + FAT_)
