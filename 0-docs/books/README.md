...
|------|---------|----------|-----------------|--------------|
| Recarga CMV | `REC_` | 102 | ass_recarga_cmv_nova (99.9M) | [book-recarga-cmv.md](book-recarga-cmv.md) |
| Pagamento | `PAG_` | 154 | pagamento (27.9M) | [book-pagamento.md](book-pagamento.md) |
| Faturamento | `FAT_` | ~108 | dados_faturamento (32.7M) | [book-faturamento.md](book-faturamento.md) |
...
```
dados_cadastrais (base, ~103 vars)
  |-- LEFT JOIN telco
  |-- LEFT JOIN score_bureau_movel (targets)
  |-- LEFT JOIN book_recarga_cmv      (REC_, 102 vars)
  |-- LEFT JOIN book_pagamento         (PAG_, 154 vars)
  |-- LEFT JOIN book_faturamento       (FAT_, ~108 vars)
  = clientes_consolidado              (~468 vars)
```
