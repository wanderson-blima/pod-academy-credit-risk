...
### Metricas de Referencia (Baseline — Run 20260311_015100)

| Metrica | LR L1 | LightGBM | Ensemble Top-3 (Champion) | Threshold |
|---------|-------|----------|---------------------------|-----------|
| KS (OOT) | 0.3314 | 0.3494 | **0.3501** | > 0.20 |
| AUC (OOT) | 0.7231 | 0.7365 | **0.7368** | > 0.65 |
| Gini (OOT) | 44.62% | 47.29% | **47.35%** | > 30% |
| PSI (Train vs OOT) | 0.0014 | 0.0009 | **0.0008** | < 0.25 |
...
| Metrica | Baseline (Ensemble Top-3) | Threshold Minimo |
|---------|--------------------------|-----------------|
| KS | 0.3501 | 0.20 |
| AUC | 0.7368 | 0.65 |
| Gini | 47.35% | 30% |
