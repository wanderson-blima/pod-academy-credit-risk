...
check "LR model artifact" \
  "oci os object head --bucket-name ${PREFIX}-gold --name model_artifacts/models/lr_l1_oci_20260311_015100.pkl --query 'content-length' 2>/dev/null"

check "LGBM model artifact" \
  "oci os object head --bucket-name ${PREFIX}-gold --name model_artifacts/models/lgbm_oci_20260311_015100.pkl --query 'content-length' 2>/dev/null"

check "Training metrics" \
  "oci os object head --bucket-name ${PREFIX}-gold --name model_artifacts/metrics/training_results_20260311_015100.json --query 'content-length' 2>/dev/null"
