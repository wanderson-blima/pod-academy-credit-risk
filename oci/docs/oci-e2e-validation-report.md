...
| 6 | 59 features selected | training_results.json: n_features=59 | PASS |
...
| 2 | Scorecard (L1 LogReg) trained | lr_l1_oci_20260217_214614.pkl (9.6 KB) | PASS |
| 3 | LightGBM (GBDT) trained | lgbm_oci_20260217_214614.pkl (486 KB) | PASS |
...
|----------|------|---------|
| `models/lr_l1_oci_20260217_214614.pkl` | 9.6 KB | L1 Logistic Regression pipeline |
| `models/lgbm_oci_20260217_214614.pkl` | 486 KB | LightGBM GBDT pipeline |
| `metrics/training_results_20260217_214614.json` | 5.5 KB | Full training metrics + parity |
| `metrics/feature_importance_20260217_214614.csv` | 1.8 KB | LightGBM feature importance |
